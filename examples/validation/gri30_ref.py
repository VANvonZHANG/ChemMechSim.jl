...
Run:  python3 examples/validation/gri30_ref.py
Writes examples/validation/output/gri30_ref_constV.csv (time_s, T_K).
Compare against examples/validation/gri30_ignition.jl."""
...
np.savetxt("examples/validation/output/gri30_ref_constV.csv", out, delimiter=",",
